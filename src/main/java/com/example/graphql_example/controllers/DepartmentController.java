...
//    public Department newDepartment(@Argument DepartmentInput department) {
    public Department newDepartment(@Argument String name, @Argument Integer organizationId) {
        Organization organization = organizationRepository
                .findById(organizationId).get();
        return departmentRepository.save(new Department(organizationId, name, null, organization));
    }
